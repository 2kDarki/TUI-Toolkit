...
def empty(msg:str = "No contents found", 
          fg: str|None = "gray", bg: str|None = None, 
...
Prints the exception message in red, optionally inline, centered, or underlined.
        """
        msg = self.msg
        if centered: msg = center(msg)
        msg_colored = color(msg, fg, bg, bold, underline)
        print(msg_colored, end='' if inline else '\n')
